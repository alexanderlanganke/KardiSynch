      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-2 p-3 rounded-lg border border-border bg-muted/30 text-xs text-muted-foreground">
            ...
            <p>European countries use <strong>europe.carelink.net</strong>. Other regions use <strong>carelink.medtronic.com</strong>. You can change this later in Settings.</p>
          </div>
        </div>
      ),
    },
