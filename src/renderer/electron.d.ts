...
export interface IElectronAPI {
  ...
  listDeviceTypeAliases: () => Promise<{ manufacturer: string; model: string; type: string; created_at: string; kind?: 'device' | 'lead'; connector?: string; role?: string; verified?: boolean }[]>;
